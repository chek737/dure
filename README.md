...
- 중앙 아티팩트 매니페스트는 파일·청크 SHA-256과 연결 관계를 DB에 등록·조회할 뿐 모델을 다운로드하거나 노드 캐시를 준비하지 않습니다. 기존 아티팩트는 매니페스트를 추측해 채우지 않고 미등록 상태로 남습니다. 콘텐츠 주소 기반 다운로드와 파일 조립은 후속 범위입니다.
