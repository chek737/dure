...
모델의 원본 출처·라이선스·허용 revision·보안 승인과 철회 책임은
[모델 반입·승인 정책](model-onboarding-policy.md)을 따릅니다. 이 문서는 승인된 immutable 입력을
등록·준비·소비하는 기술 계약이며, 레지스트리 등록 자체가 모델을 자동 승인하는 절차는 아닙니다.
